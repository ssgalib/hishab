  ...
  Future<void> initModel() async {
    try {
      ...
      _modelState = await ModelService.isDownloaded()
          ? ModelState.ready
          : ModelState.missing;
      // Speech recognition is back on Android's SpeechRecognizer; drop the
      // experimental downloads (SenseVoice/Whisper/Parakeet, ~900 MB).
      await ModelService.deleteExperimentalSpeechDownloads();
    } catch (_) {
